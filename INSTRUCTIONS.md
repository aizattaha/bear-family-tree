...
| **Expand / focus accordion** | ⊕ pills grow a side (with people-count). **One side per couple, always**: expanding upward parks your partner's side; exploring Granny's side keeps Atok's side collapsed — because two sibling fans (Atok 5th of 8 *and* Granny 3rd of 6) can never share the space around one couple. Focus bar top-left; "back to my view" resets. There is no "show all" — deliberately. |
