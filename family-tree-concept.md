...
2. **One side per couple** — the only auto-collapse, and it applies exactly where the geometry demands it. At every couple, only one partner's blood-side can be expanded at a time: expanding upward from your nucleus parks your partner's side; opening Granny's side parks Atok's. *Why:* if Atok is the 5th of 8 children and Granny the 3rd of 6, both sibling fans need the same space around the couple — there is no clean way to draw both at once. **Downward expansions never auto-collapse**: aunts' and uncles' families open side by side (children fan under their own parents, so there's no conflict), and the whole tree can be explored fully open. Family expansions also bring each child's current partner along, just as side expansions bring siblings' partners.
